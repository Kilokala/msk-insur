...
$aTabs = array(
	array(
		...
		"ICON" => "iblock_section",
		"TITLE" => htmlspecialchars($ID > 0 ? $arIBlock["SECTION_EDIT"] : $arIBlock["SECTION_ADD"]),
	),
	array(
		"DIV" => "edit2",
...
$link = "iblock_section_edit.php?mode=settings".($link <> ""? "&".$link:"");
$aMenu[] = array(
	"TEXT"=>GetMessage("admin_lib_context_sett"),
	"TITLE"=>GetMessage("admin_lib_context_sett_title"),
	"LINK"=>htmlspecialchars("javascript:".$tabControl->GetName().".ShowSettings('".urlencode(CUtil::JSEscape($link))."')"),
	"ICON"=>"btn_settings",
);
